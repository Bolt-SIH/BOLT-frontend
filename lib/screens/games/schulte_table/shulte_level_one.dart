...
class SchulteLevelOne extends StatefulWidget {
  static const routeName = '/SchulteLevelOne';
  const SchulteLevelOne({Key? key}) : super(key: key);

  @override
  State<SchulteLevelOne> createState() => _SchulteLevelOneState();
}

class _SchulteLevelOneState extends State<SchulteLevelOne> {
